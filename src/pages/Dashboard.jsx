...
function Dashboard() {
  ...
  const resetDemoData = () => {
    const confirmed = window.confirm(
      "Reset all demo patient data?"
    );

    if (!confirmed) return;

    localStorage.removeItem("medipath_patients");
                ...
                <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      className="bg-white/10 hover:bg-white/20 border border-white/20 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-all"
                    >
                      ↻ Reset Demo
                    </button>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#0f766e] mt-1 leading-relaxed">
                    MediPath is currently using mock patient data.
                    When Member 1's backend is connected, the
                    service layer can use the real APIs without
                    redesigning this frontend.
                  </p>
